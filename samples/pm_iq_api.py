    ...
    return {
        ...
        "modes": [
            ...
            },
            {
                ...
                "description": (
                    "цикл «с чистого листа» на каждом шаге (полный текст, с описаниями виджетов, выбранных роутером методичек (плюс отдельный каталог виджетов из них) + растущий блок получаемых из ИС данных + исходный вопрос), история цикла ReAct не накапливается - требует бОльшего контекстного окна LLM"
                ),
            },
        ],
    }
