    ...
    intents:
      - name: mitigation_plan_action
        description: >
          ...
          ТЫ ДОЛЖЕН заполнить поля карточки самостоятельно на основе данных из Observation:
          ...
          - button.text: конкретное действие, например "Активировать план для R-001"
          ...
          Пример правильно заполненной карточки:
          {
            ...
            "title": "R-001: Задержка поставки серверов",
            ...
            "button": {
              "text": "Активировать план для R-001",
              "action": "activate_mitigation_plan",
              "payload": { "risk_id": "R-001", "owner": "Ivanov I.I.", "project_name": "ERP_Migration" }
            },
            "config": {},
            "data_rows": []
          }
