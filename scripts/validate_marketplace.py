...
class MarketplaceValidator:
    ...
    def _validate_skill_entry(self, plugin_name: str, skill_path_str: str) -> None:
        ...
        if not skill_file.exists():
            self.error(f"Plugin '{plugin_name}': skill missing SKILL.md at {skill_file}")
            return
